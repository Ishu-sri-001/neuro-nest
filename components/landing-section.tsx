export default function LandingSections() {
  ...
  },
  {
    ...
    description: "Unlike traditional therapy with scheduled appointments, NeuroNest is available whenever you need it. Our AI learns from your interactions to provide increasingly personalized guidance, coping strategies, and emotional support that grows more effective over time, ensuring you are never alone in your mental health journey."
  }
];

  return (
    <div className="space-y-10 bg-gradient-to-b from-blue-50 via-white to-purple-50">
      {/* Hero Section */}
      <section className="container mx-auto px-4 py-6 lg:py-12 text-center relative" id="home">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl md:text-7xl font-bold mb-5 lg:mb-8 bg-gradient-to-r from-purple-600 via-blue-600 to-teal-600 bg-clip-text text-transparent">
            Welcome to NeuroNest
          </h1>
          <p className="text-sm md:text-2xl text-gray-700 mx-3 lg:max-w-4xl lg:mx-auto mb-4 lg:mb-12 leading-relaxed">
      ...
      {/* Features Section */}
      <section className="container mx-auto px-4 pt-10 lg:py-20 relative" id="features">
      ...
      {/* About Section */}
      <section className="container mx-auto px-4 py-2 md:py-12 relative" id="about">
        <div className="bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 rounded-3xl p-12 shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="text-sm md:text-xl text-gray-700 text-center max-w-4xl mx-auto space-y-6 leading-relaxed">
              <p className="text-base md:text-xl font-medium">At NeuroNest, we believe mental health support shouldn&apos;t be limited by appointments, waiting lists, or location. We&apos;ve created more than just a chatbot – we&apos;ve built a digital companion that truly listens, learns, and cares.</p>
      ...
      <section className="container mx-auto px-4 py-16" id='contact'>
        ...
        <div className="max-w-xs md:max-w-lg mx-auto bg-white p-10 border-2 border-gray-100 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-purple-500 via-blue-500 to-teal-500"></div>
          
          <p className="text-center mb-8 text-base md:text-xl text-gray-700 font-medium">Have questions? We&apos;d love to hear from you!</p>
          <div className="space-y-6">
            <div className="flex items-center justify-center bg-gradient-to-r from-purple-50 to-blue-50 p-4 rounded-xl">
              ...
              <span className="text-gray-700 text-base md:text-lg font-medium">contact@neuronest.ai</span>
            </div>
            <div className="flex items-center justify-center bg-gradient-to-r from-blue-50 to-teal-50 p-4 rounded-xl">
              ...
              <span className="text-gray-700 text-base md:text-lg font-medium">+1 (555) 123-4567</span>
            </div>
          </div>
        </div>
      </section>
